...
public class Cliente{ 
	...
	@Size(min=5, max=20, message="El tamaño debe estar entre 5 y 20 caracteres") // TAMAÑO MINIMO 5 Y MAXIMO 20
	...
	@Size(min=4, max=20, message="El tamaño debe estar entre 4 y 20 caracteres") // TAMAÑO MINIMO 4 Y MAXIMO 20
	...
	@Size(min=8, max=8, message="El tamaño debe ser 5 caracteres") // TAMAÑO MINIMO 8 Y MAXIMO 8
	...
	@Size(min=9, max=9, message="El tamaño debe ser 9 caracteres") // TAMAÑO MINIMO 9 Y MAXIMO 9
